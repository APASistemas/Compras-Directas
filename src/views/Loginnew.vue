    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          <img src="../assets/logo-apa.png" id="icon" alt="User Icon" />
        </div>
  ...
  methods: {
    ...
    login() {
      ...
      if (json.usuario != "" && json.password != "") {
        if (
          (json.usuario == "ramirotule@gmail.com" &&
            json.password == "Miba1216") ||
          (json.usuario == "jpascual" && json.password == "Rocoso2019")
        ) {
